...
export default function OnboardingPage({ user }: OnboardingPageProps) {
  ...
  const updateProfileMutation = useMutation({
    ...
    onSuccess: (updatedUser) => {
      ...
      toast({
        title: "Welcome to Restaurant AI Consulting!",
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex items-center justify-between px-6 py-4 border-b">
        <div className="flex items-center gap-3">
          <img src={logoImage} alt="Restaurant AI Consulting" className="h-8 w-8 rounded-xl object-contain ring-1 ring-primary/20" />
          <span className="font-bold text-sm tracking-tight">Restaurant AI Consulting</span>
        </div>
        <Button
          variant="ghost"
          size="sm"
