...
export const handbookSettings = pgTable("handbook_settings", {
  ...
  schedulingApp: text("scheduling_app"),
  posSystem: text("pos_system"),
  posSystemOther: text("pos_system_other"),
  servicePeriods: text("service_periods").array(),
  operatingHours: text("operating_hours"),
  seatingCapacity: integer("seating_capacity"),
  tippingStructure: text("tipping_structure"),
  breakPolicy: text("break_policy"),
  evaluationSchedule: text("evaluation_schedule"),
  orientationDays: integer("orientation_days").default(30),
  closedHolidays: text("closed_holidays").array(),
  signatureDishesFoh: text("signature_dishes_foh"),
  signatureDishesBoh: text("signature_dishes_boh"),
  kitchenStations: text("kitchen_stations").array(),
  allergenOptions: text("allergen_options").array(),
  brandVoice: text("brand_voice"),
  weeklySpecials: text("weekly_specials"),
  happyHourDetails: text("happy_hour_details"),
  alcoholPolicy: text("alcohol_policy"),
  socialMediaPolicy: text("social_media_policy"),
  additionalPolicies: text("additional_policies"),
  barManager: text("bar_manager"),
  headBartender: text("head_bartender"),
  alcoholPermit: text("alcohol_permit"),
  signatureCocktail1: text("signature_cocktail_1"),
  signatureCocktail2: text("signature_cocktail_2"),
  signatureCocktail3: text("signature_cocktail_3"),
  draftBeerCount: integer("draft_beer_count"),
  closingTime: text("closing_time"),
  laborTargetPct: text("labor_target_pct"),
  foodCostTarget: text("food_cost_target"),
  primeCostTarget: text("prime_cost_target"),
  safeDropProcedure: text("safe_drop_procedure"),
  vendorList: text("vendor_list"),
  emergencyContacts: text("emergency_contacts"),
  reservationSystem: text("reservation_system"),
  totalCovers: integer("total_covers"),
  avgTurnTime: integer("avg_turn_time"),
  openingTime: text("opening_time"),
  weeklyRevenue: text("weekly_revenue"),
  avgCheck: text("avg_check"),
  weeklyCovers: integer("weekly_covers"),
  foodCostActual: text("food_cost_actual"),
  laborCostActual: text("labor_cost_actual"),
